...
![nav](figures/baseline_v2_market_style_nav.png)

![drawdown](figures/baseline_v2_market_style_drawdown.png)

![period_cumulative_return](figures/baseline_v2_period_cumulative_return.png)

![market_beta_proxy](figures/baseline_v2_market_beta_proxy.png)

![forced_loss_share](figures/baseline_v2_forced_loss_share.png)

![sell_fail_rate](figures/baseline_v2_sell_fail_rate.png)

![top10_loss_share](figures/baseline_v2_top10_loss_share.png)

![size_minus_large](figures/baseline_v2_size_minus_large.png)
